...
function OrdersListForProviders(){
const { t } = useTranslation();
    ...
    //Getting orders for list and providers for select
    useEffect(() => {
        axios
    ...
    //Filtering orders by provider/state
    useEffect(() => {
        let result = orders;

        if (selectedProvider.comName) {
            result = result.filter(o => o.comName === selectedProvider.comName);
        }
    ...
    const handleAddSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`/companies/${selectedProvider.idCompany}/orders`, formData);
...
export default OrdersListForProviders;